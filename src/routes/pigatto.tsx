      ...
      <div className="relative hidden bg-gradient-to-r from-sidebar via-sidebar to-background lg:block">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-12">
          <div className="max-w-xs text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Central de Produção</h2>
      ...
      <div className="flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-4 flex justify-center">
            <div className="inline-flex items-center gap-2 rounded-full bg-primary-soft/50 px-3 py-1 text-xs font-medium text-primary">
              <ShieldCheck className="size-3.5" /> Acesso restrito
            </div>
          </div>

          <h1 className="text-center text-2xl font-semibold">Entrar no laboratório</h1>
